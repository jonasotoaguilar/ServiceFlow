...
function Badge({
  ...
  const variants = {
    ...
    success:
      "border-transparent bg-green-500 text-white dark:bg-green-900 dark:text-green-100",
    warning:
      "border-transparent bg-yellow-500 text-white dark:bg-yellow-900 dark:text-yellow-100",
  };
