...
const alertStyles: Record<AlertVariant, { container: string; icon: string; iconBg: string }> = {
	error: {
		container:
...
export function Alert({ variant, title, message, onClose }: Readonly<AlertProps>) {
