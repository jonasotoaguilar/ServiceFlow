							...
							<tbody className="divide-y divide-border">
										...
										<td className="px-6 py-5">
											<div className="flex items-center gap-4">
												...
												>
													<MapPin
														className={`w-5 h-5 ${
															loc.isActive ? "text-emerald-500" : "text-foreground-subtle"
														}`}
													/>
												</div>
												<div>
								...
								{currentItems.length === 0 && (
									<tr>
										<td
											colSpan={5}
											className="px-6 py-16 text-center text-foreground-subtle italic"
										>
				...
				<form onSubmit={editingLocation ? handleUpdate : handleCreate} className="space-y-6">
					...
					<div>
						...
						<input
							...
							maxLength={20}
							className={`w-full bg-surface-muted border ${nameError ? "border-red-500" : "border-border"} rounded-lg px-4 py-2.5 text-foreground placeholder:text-foreground-subtle focus:ring-2 focus:ring-primary focus:border-primary transition-all outline-none`}
					...
					<div className="flex gap-3 justify-end pt-4">
						<button
							type="button"
							onClick={closeDialog}
							className="px-4 py-2 rounded-lg border border-border text-foreground hover:bg-surface-muted transition-all"
						>
							Cancelar
						</button>
						<button
